...
//Pub part can be like that 
// public async publishMessage(stock: string, message: string): Promise<void> {
//     await this.redisClient.publish(stock, message);
//     console.log(`Published message to channel ${stock}: ${message}`);
// }